...
Tags: User, Role, Redirection,  Hide Admin Bar, Restrict Dashboard
...
1. Upload the `role-based-redirect` folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. Go to the **Users Redirect** menu in the WordPress admin sidebar to configure redirection and role-based options.
...
1. Plugin settings page where you can configure redirection and access options by role.
...
= 1.6 =
Recommended update for better compatibility, security enhancements, and improved user role handling.
